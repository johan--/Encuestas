...
(function(root, factory) {
  ...
  _.extend(Collection.prototype, Events, {
	...
	/*console.log("MOMO",models)
	console.log("MODELS",models)
	console.log("idiomas",idiomas)

	var idiomContador=0
	for (x in models) {
    console.log("OPcion",models[x])
	
	if (models[x]["language"] ==idiomas[idiomContador]){
	 console.log("Bien",models[x]["language"])
	idiomContador++;
	if ((idiomContador +1)> idiomas.length) {
	console.log("ENTRA",idiomContador,idiomas.length)
	idiomContador=0;
	}
	}else{
	console.log("Mal",models[x])
	console.log("VAR",models[x])
	 var nuevoModelo=models[x-1];
	 nuevoModelo["language"]=idiomas[idiomContador]
	 models.splice(x+1, 0, nuevoModelo);
	 //models.push(nuevoModelo)
	}
	
		//for (x in idiomas) {
    //console.log("Idioma es :",idiomas[x])
//}
}*/
console.log("LE MODEL ES ",models)
      options || (options = {});
