...
class cdefault {
	...
	function Page_Main() {
		...
		$this->Page_Terminate("clienteslist.php"); // Exit and go to default page
		if ($Security->AllowList(CurrentProjectID() . 'encuestas'))
			$this->Page_Terminate("encuestaslist.php");
		if ($Security->AllowList(CurrentProjectID() . 'eventos'))
			$this->Page_Terminate("eventoslist.php");
		if ($Security->AllowList(CurrentProjectID() . 'idioma'))
			$this->Page_Terminate("idiomalist.php");
		if ($Security->AllowList(CurrentProjectID() . 'plantilla_encuestas'))
			$this->Page_Terminate("plantilla_encuestaslist.php");
		...
		if ($Security->AllowList(CurrentProjectID() . 'controles'))
			$this->Page_Terminate("controleslist.php");
