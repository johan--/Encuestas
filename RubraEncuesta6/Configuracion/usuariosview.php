...
<!--first page button-->
	...
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $usuarios_view->PageUrl() ?>start=<?php echo $usuarios_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($usuarios_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $usuarios_view->PageUrl() ?>start=<?php echo $usuarios_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $usuarios_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($usuarios_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $usuarios_view->PageUrl() ?>start=<?php echo $usuarios_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($usuarios_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $usuarios_view->PageUrl() ?>start=<?php echo $usuarios_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $usuarios_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
...
<?php if ($usuarios->id_usuario->Visible) { // id_usuario ?>
	<tr id="r_id_usuario">
		<td><span id="elh_usuarios_id_usuario"><?php echo $usuarios->id_usuario->FldCaption() ?></span></td>
		<td<?php echo $usuarios->id_usuario->CellAttributes() ?>>
<span id="el_usuarios_id_usuario" class="form-group">
<span<?php echo $usuarios->id_usuario->ViewAttributes() ?>>
<?php echo $usuarios->id_usuario->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span id="el_usuarios_nombre" class="form-group">
...
<?php if ($usuarios->apellido->Visible) { // apellido ?>
	<tr id="r_apellido">
		<td><span id="elh_usuarios_apellido"><?php echo $usuarios->apellido->FldCaption() ?></span></td>
		<td<?php echo $usuarios->apellido->CellAttributes() ?>>
<span id="el_usuarios_apellido" class="form-group">
<span<?php echo $usuarios->apellido->ViewAttributes() ?>>
<?php echo $usuarios->apellido->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span id="el_usuarios_usuario" class="form-group">
...
<span id="el_usuarios_password" class="form-group">
...
<?php if ($usuarios->mail->Visible) { // mail ?>
	<tr id="r_mail">
		<td><span id="elh_usuarios_mail"><?php echo $usuarios->mail->FldCaption() ?></span></td>
		<td<?php echo $usuarios->mail->CellAttributes() ?>>
<span id="el_usuarios_mail" class="form-group">
<span<?php echo $usuarios->mail->ViewAttributes() ?>>
<?php echo $usuarios->mail->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($usuarios->estado->Visible) { // estado ?>
	<tr id="r_estado">
		<td><span id="elh_usuarios_estado"><?php echo $usuarios->estado->FldCaption() ?></span></td>
		<td<?php echo $usuarios->estado->CellAttributes() ?>>
<span id="el_usuarios_estado" class="form-group">
<span<?php echo $usuarios->estado->ViewAttributes() ?>>
<?php echo $usuarios->estado->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
