...
$plantilla_encuestas_logo_encuesta_blobview = NULL; // Initialize page object first

class cplantilla_encuestas_logo_encuesta_blobview extends cplantilla_encuestas {
	...
	// Page object name
	var $PageObjName = 'plantilla_encuestas_logo_encuesta_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'plantilla_encuestas');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('plantilla_encuestas', 'x_logo_encuesta');
		...
		if ($this->Recordset = $conn->Execute($sSql)) {
			if (!$this->Recordset->EOF) {
				if (!EW_DEBUG_ENABLED && ob_get_length())
					ob_end_clean();
				$objBinary->Value = $this->Recordset->fields('logo_encuesta');
...
// Create page object
if (!isset($plantilla_encuestas_logo_encuesta_blobview)) $plantilla_encuestas_logo_encuesta_blobview = new cplantilla_encuestas_logo_encuesta_blobview();

// Page init
$plantilla_encuestas_logo_encuesta_blobview->Page_Init();

// Page main
$plantilla_encuestas_logo_encuesta_blobview->Page_Main();
?>
<?php
$plantilla_encuestas_logo_encuesta_blobview->Page_Terminate();
?>
