...
class cusuarios_list extends cusuarios {
	...
	function SetupKeyValues($key) {
		...
		if (count($arrKeyFlds) >= 1) {
			$this->id_usuario->setFormValue($arrKeyFlds[0]);
			if (!is_numeric($this->id_usuario->FormValue))
				return FALSE;
		}
		return TRUE;
	}
	...
	function LoadSortOrder() {
		...
		if ($sOrderBy == "") {
			if ($this->getSqlOrderBy() <> "") {
				...
				$this->usuario->setSort("ASC");
				$this->apellido->setSort("ASC");
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->id_usuario->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event, this);'>";
	...
	function SetupOtherOptions() {
		...
		$item->Body = "<a class=\"ewAction ewMultiDelete\" title=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" href=\"\" onclick=\"ew_SubmitSelected(document.fusuarioslist, '" . $this->MultiDeleteUrl . "', ewLanguage.Phrase('DeleteMultiConfirmMsg'));return false;\">" . $Language->Phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = ($Security->CanDelete());
...
<option value="10"<?php if ($usuarios_list->DisplayRecs == 10) { ?> selected="selected"<?php } ?>>10</option>
<option value="25"<?php if ($usuarios_list->DisplayRecs == 25) { ?> selected="selected"<?php } ?>>25</option>
<option value="50"<?php if ($usuarios_list->DisplayRecs == 50) { ?> selected="selected"<?php } ?>>50</option>
<option value="100"<?php if ($usuarios_list->DisplayRecs == 100) { ?> selected="selected"<?php } ?>>100</option>
<option value="ALL"<?php if ($usuarios->getRecordsPerPage() == -1) { ?> selected="selected"<?php } ?>><?php echo $Language->Phrase("AllRecords") ?></option>
</select>
</div>
<?php } ?>
</form>
...
<?php if ($usuarios->id_usuario->Visible) { // id_usuario ?>
	<?php if ($usuarios->SortUrl($usuarios->id_usuario) == "") { ?>
		<th data-name="id_usuario"><div id="elh_usuarios_id_usuario" class="usuarios_id_usuario"><div class="ewTableHeaderCaption"><?php echo $usuarios->id_usuario->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id_usuario"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->id_usuario) ?>',1);"><div id="elh_usuarios_id_usuario" class="usuarios_id_usuario">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->id_usuario->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->id_usuario->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->id_usuario->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<?php if ($usuarios->apellido->Visible) { // apellido ?>
	<?php if ($usuarios->SortUrl($usuarios->apellido) == "") { ?>
		<th data-name="apellido"><div id="elh_usuarios_apellido" class="usuarios_apellido"><div class="ewTableHeaderCaption"><?php echo $usuarios->apellido->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="apellido"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->apellido) ?>',1);"><div id="elh_usuarios_apellido" class="usuarios_apellido">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->apellido->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->apellido->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->apellido->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($usuarios->usuario->Visible) { // usuario ?>
	...
	<?php } else { ?>
		<th data-name="usuario"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->usuario) ?>',1);"><div id="elh_usuarios_usuario" class="usuarios_usuario">
...
<?php if ($usuarios->mail->Visible) { // mail ?>
	<?php if ($usuarios->SortUrl($usuarios->mail) == "") { ?>
		<th data-name="mail"><div id="elh_usuarios_mail" class="usuarios_mail"><div class="ewTableHeaderCaption"><?php echo $usuarios->mail->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="mail"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->mail) ?>',1);"><div id="elh_usuarios_mail" class="usuarios_mail">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->mail->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->mail->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->mail->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($usuarios->estado->Visible) { // estado ?>
	<?php if ($usuarios->SortUrl($usuarios->estado) == "") { ?>
		<th data-name="estado"><div id="elh_usuarios_estado" class="usuarios_estado"><div class="ewTableHeaderCaption"><?php echo $usuarios->estado->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="estado"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->estado) ?>',1);"><div id="elh_usuarios_estado" class="usuarios_estado">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->estado->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->estado->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->estado->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
?>
	<?php if ($usuarios->id_usuario->Visible) { // id_usuario ?>
		<td data-name="id_usuario"<?php echo $usuarios->id_usuario->CellAttributes() ?>>
...
<?php echo $usuarios->nombre->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($usuarios->apellido->Visible) { // apellido ?>
		<td data-name="apellido"<?php echo $usuarios->apellido->CellAttributes() ?>>
...
<?php echo $usuarios->usuario->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($usuarios->mail->Visible) { // mail ?>
		<td data-name="mail"<?php echo $usuarios->mail->CellAttributes() ?>>
<span<?php echo $usuarios->mail->ViewAttributes() ?>>
<?php echo $usuarios->mail->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($usuarios->estado->Visible) { // estado ?>
		<td data-name="estado"<?php echo $usuarios->estado->CellAttributes() ?>>
