...
$clientes_ImagenLogo_blobview = NULL; // Initialize page object first

class cclientes_ImagenLogo_blobview extends cclientes {
	...
	// Page object name
	var $PageObjName = 'clientes_ImagenLogo_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'clientes');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('clientes', 'x_ImagenLogo');
		...
		if ($this->Recordset = $conn->Execute($sSql)) {
			if (!$this->Recordset->EOF) {
				if (!EW_DEBUG_ENABLED && ob_get_length())
					ob_end_clean();
				$objBinary->Value = $this->Recordset->fields('ImagenLogo');
...
// Create page object
if (!isset($clientes_ImagenLogo_blobview)) $clientes_ImagenLogo_blobview = new cclientes_ImagenLogo_blobview();

// Page init
$clientes_ImagenLogo_blobview->Page_Init();

// Page main
$clientes_ImagenLogo_blobview->Page_Main();
?>
<?php
$clientes_ImagenLogo_blobview->Page_Terminate();
?>
