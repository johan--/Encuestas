        ...
        <div class="form-container" style="
            ...
            <div id="tmm-form-wizard" class="container substrate" style="
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        <h2 class="form-login-heading">Edicion Plantilla<span></span></h2>
                    </div>
                ...
                <div class="row stage-container">
                    ...
                    <div class="stage col-md-3 col-sm-3" id="stage3">
                        <div class="stage-header head-icon head-icon-details"></div>
                        <div class="stage-content">
                            <h3 class="stage-title">Confirma la Edicion</h3>
                            <div class="stage-info">
                                Guarda la Edicion de la Plantilla
                            </div>
                        </div>
                    </div>
                    <!--/ .stage-->
...
">Ver Preview</a>
    ...
    <script>
        ...
        $(document).ready(function() {
            //
            var objetoEditar = {}
			idPlantilla=getParameterByName("id");
            objetoEditar.id = idPlantilla;
            ...
            $.ajax({
                ...
                success: function(msg) {
                    ...
                    console.log("Plantilla", encuesta)
                    getIdiomas();
            ...
            $("#guardar").click(function() {
                ...
                objetoPlantilla.id = idPlantilla;
                ...
                $.ajax({
                    url: '/encuestarubra/RubraEncuesta7/clases/updatePlantilla.php',
                    type: 'post',
                    data: {
