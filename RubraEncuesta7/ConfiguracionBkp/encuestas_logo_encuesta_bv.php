...
$encuestas_logo_encuesta_blobview = NULL; // Initialize page object first

class cencuestas_logo_encuesta_blobview extends cencuestas {
	...
	// Page object name
	var $PageObjName = 'encuestas_logo_encuesta_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'encuestas');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('encuestas', 'x_logo_encuesta');
...
// Create page object
if (!isset($encuestas_logo_encuesta_blobview)) $encuestas_logo_encuesta_blobview = new cencuestas_logo_encuesta_blobview();

// Page init
$encuestas_logo_encuesta_blobview->Page_Init();

// Page main
$encuestas_logo_encuesta_blobview->Page_Main();
?>
<?php
$encuestas_logo_encuesta_blobview->Page_Terminate();
?>
