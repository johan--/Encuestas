...
//
// Table class for eventos
//
class ceventos extends cTable {
	var $Id;
	var $Nombre;
	var $idCliente;
	var $Descripcion;
	...
	function __construct() {
		...
		// Id
		$this->Id = new cField('eventos', 'eventos', 'x_Id', 'Id', '`Id`', '`Id`', 3, -1, FALSE, '`Id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->Id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id'] = &$this->Id;

		// Nombre
		$this->Nombre = new cField('eventos', 'eventos', 'x_Nombre', 'Nombre', '`Nombre`', '`Nombre`', 200, -1, FALSE, '`Nombre`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Nombre'] = &$this->Nombre;

		// idCliente
		$this->idCliente = new cField('eventos', 'eventos', 'x_idCliente', 'idCliente', '`idCliente`', '`idCliente`', 3, -1, FALSE, '`idCliente`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->idCliente->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['idCliente'] = &$this->idCliente;

		// Descripcion
		$this->Descripcion = new cField('eventos', 'eventos', 'x_Descripcion', 'Descripcion', '`Descripcion`', '`Descripcion`', 200, -1, FALSE, '`Descripcion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Descripcion'] = &$this->Descripcion;

		// FechaInicio
		$this->FechaInicio = new cField('eventos', 'eventos', 'x_FechaInicio', 'FechaInicio', '`FechaInicio`', 'DATE_FORMAT(`FechaInicio`, \'%d/%m/%Y\')', 133, 7, FALSE, '`FechaInicio`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->FechaInicio->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['FechaInicio'] = &$this->FechaInicio;

		// FechaFin
		$this->FechaFin = new cField('eventos', 'eventos', 'x_FechaFin', 'FechaFin', '`FechaFin`', 'DATE_FORMAT(`FechaFin`, \'%d/%m/%Y\')', 133, 7, FALSE, '`FechaFin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->FechaFin->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['FechaFin'] = &$this->FechaFin;

		// Estado
		$this->Estado = new cField('eventos', 'eventos', 'x_Estado', 'Estado', '`Estado`', '`Estado`', 200, -1, FALSE, '`Estado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`eventos`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("eventosview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("eventosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "eventosadd.php?" . $this->UrlParm($parm);
		else
			return "eventosadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("eventosedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("eventosadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("eventosdelete.php", $this->UrlParm());
	}
