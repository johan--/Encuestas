...
class cclientes_list extends cclientes {
	...
	function LoadSearchValues() {
		...
		// Comentario
		$this->Comentario->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_Comentario"]);
		if ($this->Comentario->AdvancedSearch->SearchValue <> "") $this->Command = "search";
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			$this->RazonSocial->EditValue = ew_HtmlEncode($this->RazonSocial->AdvancedSearch->SearchValue);
...
fclienteslistsrch.Validate = function(fobj) {
...
// Form_CustomValidate event
fclienteslistsrch.Form_CustomValidate = 
 function(fobj) { // DO NOT CHANGE THIS LINE!
...
// Use JavaScript validation or not
<?php if (EW_CLIENT_VALIDATE) { ?>
fclienteslistsrch.ValidateRequired = true; // Use JavaScript validation
<?php } else { ?>
fclienteslistsrch.ValidateRequired = false; // No JavaScript validation
<?php } ?>
...
<?php
if ($gsSearchError == "")
	$clientes_list->LoadAdvancedSearch(); // Load advanced search

// Render for search
$clientes->RowType = EW_ROWTYPE_SEARCH;
...
<?php if ($clientes->RazonSocial->Visible) { // RazonSocial ?>
	<div id="xsc_RazonSocial" class="ewCell form-group">
		<label for="x_RazonSocial" class="ewSearchCaption ewLabel"><?php echo $clientes->RazonSocial->FldCaption() ?></label>
		<span class="ewSearchOperator"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_RazonSocial" id="z_RazonSocial" value="LIKE"></span>
...
<?php if ($clientes->Estado->Visible) { // Estado ?>
	<div id="xsc_Estado" class="ewCell form-group">
		<label for="x_Estado" class="ewSearchCaption ewLabel"><?php echo $clientes->Estado->FldCaption() ?></label>
...
if (is_array($clientes->Estado->EditValue)) {
	...
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($clientes->Estado->AdvancedSearch->SearchValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
...
<!--first page button-->
	...
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $clientes_list->PageUrl() ?>start=<?php echo $clientes_list->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($clientes_list->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $clientes_list->PageUrl() ?>start=<?php echo $clientes_list->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $clientes_list->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($clientes_list->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $clientes_list->PageUrl() ?>start=<?php echo $clientes_list->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($clientes_list->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $clientes_list->PageUrl() ?>start=<?php echo $clientes_list->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<option value="10"<?php if ($clientes_list->DisplayRecs == 10) { ?> selected="selected"<?php } ?>>10</option>
<option value="25"<?php if ($clientes_list->DisplayRecs == 25) { ?> selected="selected"<?php } ?>>25</option>
<option value="50"<?php if ($clientes_list->DisplayRecs == 50) { ?> selected="selected"<?php } ?>>50</option>
<option value="100"<?php if ($clientes_list->DisplayRecs == 100) { ?> selected="selected"<?php } ?>>100</option>
<option value="ALL"<?php if ($clientes->getRecordsPerPage() == -1) { ?> selected="selected"<?php } ?>><?php echo $Language->Phrase("AllRecords") ?></option>
</select>
</div>
<?php } ?>
</form>
...
?>
<?php if ($clientes->RazonSocial->Visible) { // RazonSocial ?>
	<?php if ($clientes->SortUrl($clientes->RazonSocial) == "") { ?>
		<th data-name="RazonSocial"><div id="elh_clientes_RazonSocial" class="clientes_RazonSocial"><div class="ewTableHeaderCaption"><?php echo $clientes->RazonSocial->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="RazonSocial"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $clientes->SortUrl($clientes->RazonSocial) ?>',1);"><div id="elh_clientes_RazonSocial" class="clientes_RazonSocial">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $clientes->RazonSocial->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($clientes->RazonSocial->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($clientes->RazonSocial->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($clientes->Comentario->Visible) { // Comentario ?>
	<?php if ($clientes->SortUrl($clientes->Comentario) == "") { ?>
		<th data-name="Comentario"><div id="elh_clientes_Comentario" class="clientes_Comentario"><div class="ewTableHeaderCaption"><?php echo $clientes->Comentario->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Comentario"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $clientes->SortUrl($clientes->Comentario) ?>',1);"><div id="elh_clientes_Comentario" class="clientes_Comentario">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $clientes->Comentario->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($clientes->Comentario->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($clientes->Comentario->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($clientes->Estado->Visible) { // Estado ?>
	<?php if ($clientes->SortUrl($clientes->Estado) == "") { ?>
		<th data-name="Estado"><div id="elh_clientes_Estado" class="clientes_Estado"><div class="ewTableHeaderCaption"><?php echo $clientes->Estado->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Estado"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $clientes->SortUrl($clientes->Estado) ?>',1);"><div id="elh_clientes_Estado" class="clientes_Estado">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $clientes->Estado->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($clientes->Estado->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($clientes->Estado->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
?>
	<?php if ($clientes->RazonSocial->Visible) { // RazonSocial ?>
		<td data-name="RazonSocial"<?php echo $clientes->RazonSocial->CellAttributes() ?>>
...
<a id="<?php echo $clientes_list->PageObjName . "_row_" . $clientes_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($clientes->Comentario->Visible) { // Comentario ?>
		<td data-name="Comentario"<?php echo $clientes->Comentario->CellAttributes() ?>>
<span<?php echo $clientes->Comentario->ViewAttributes() ?>>
<?php echo $clientes->Comentario->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($clientes->Estado->Visible) { // Estado ?>
		<td data-name="Estado"<?php echo $clientes->Estado->CellAttributes() ?>>
