...
$EW_ROOT_RELATIVE_PATH = "..\..\..\..\Users\kaloye\Documents\PHPMaker\Projects\project2"; // Relative path of app root
...
define("EW_PROJECT_ID", "{ADE930FF-1B1F-40A3-B075-C7C26BDE4A4A}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'hxoNAUq7IDqqjR6q', TRUE); // Random key for encryption
...
define("EW_CONN_USER", 'l9000265_rubra', TRUE);
define("EW_CONN_PASS", 'piPOba65be', TRUE);
define("EW_CONN_DB", 'l9000265_rubra', TRUE);
...
define("EW_USER_EMAIL_FILTER", "(`mail` = '%e')",  TRUE);
...
define("EW_USER_PROFILE_CONCURRENT_SESSION_COUNT", 3, TRUE); // Maximum sessions allowed
define("EW_USER_PROFILE_SESSION_TIMEOUT", 60, TRUE);
...
define("EW_SENDER_EMAIL", "kaloye_ale@hotmail.com", TRUE); // Sender email address
define("EW_RECIPIENT_EMAIL", "kaloye_ale@hotmail.com", TRUE); // Recipient email address
