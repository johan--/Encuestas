...
<?php if ($audittrail_view->Pager->RecordCount > 0) { ?>
<div class="ewPager">
...
<span id="el_audittrail_id" class="form-group">
...
<span id="el_audittrail_datetime" class="form-group">
...
<span id="el_audittrail_script" class="form-group">
...
<span id="el_audittrail_user" class="form-group">
...
<span id="el_audittrail_action" class="form-group">
...
<span id="el_audittrail__table" class="form-group">
...
<span id="el_audittrail__field" class="form-group">
...
<span id="el_audittrail_keyvalue" class="form-group">
...
<span id="el_audittrail_oldvalue" class="form-group">
...
<span id="el_audittrail_newvalue" class="form-group">
