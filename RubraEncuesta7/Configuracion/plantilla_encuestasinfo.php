...
$plantilla_encuestas = NULL;

//
// Table class for plantilla_encuestas
//
class cplantilla_encuestas extends cTable {
	var $id;
	var $logo_encuesta;
	var $rtaMultiple;
	var $estado;
	...
	function __construct() {
		...
		$this->TableVar = 'plantilla_encuestas';
		$this->TableName = 'plantilla_encuestas';
		...
		// id
		$this->id = new cField('plantilla_encuestas', 'plantilla_encuestas', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// logo_encuesta
		$this->logo_encuesta = new cField('plantilla_encuestas', 'plantilla_encuestas', 'x_logo_encuesta', 'logo_encuesta', '`logo_encuesta`', '`logo_encuesta`', 205, -1, TRUE, '`logo_encuesta`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->logo_encuesta->UploadMaxFileSize = 10000;
		$this->fields['logo_encuesta'] = &$this->logo_encuesta;

		// rtaMultiple
		$this->rtaMultiple = new cField('plantilla_encuestas', 'plantilla_encuestas', 'x_rtaMultiple', 'rtaMultiple', '`rtaMultiple`', '`rtaMultiple`', 200, -1, FALSE, '`rtaMultiple`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['rtaMultiple'] = &$this->rtaMultiple;

		// estado
		$this->estado = new cField('plantilla_encuestas', 'plantilla_encuestas', 'x_estado', 'estado', '`estado`', '`estado`', 200, -1, FALSE, '`estado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`plantilla_encuestas`";
	}
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`estado` ASC";
	}
	...
	// Update Table
	var $UpdateTable = "`plantilla_encuestas`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "plantilla_encuestaslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("plantilla_encuestasview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("plantilla_encuestasview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "plantilla_encuestasadd.php?" . $this->UrlParm($parm);
		else
			return "plantilla_encuestasadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("plantilla_encuestasedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("plantilla_encuestasadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("plantilla_encuestasdelete.php", $this->UrlParm());
	}
