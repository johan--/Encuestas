...
var textosControles=[];
var fieldTypeSeleccionado;
textosControles["paragraph"]="Parrafo";
textosControles["text"]="Texto";
textosControles["checkboxes"]="Checkboxes";
textosControles["radio"]="Opciones";
textosControles["number"]="Numero";
textosControles["dropdown"]="Combo";
textosControles["website"]="Sitio Web";
textosControles["email"]="Email";
textosControles["date"]="Fecha";
textosControles["price"]="Precio";
textosControles["address"]="Direccion";

function getTextoControl(){
  if (textosControles[fieldTypeSeleccionado]==null){
  return fieldTypeSeleccionado
  }else{
  return textosControles[fieldTypeSeleccionado]
  }
...
(function() {
  ...
  ViewFieldView = (function(_super) {
	...
	console.log("Element ", this.$el.find(".subtemplate-wrapper" ))
	 if (this.$el.find(".subtemplate-wrapper" ).length>0){
	  console.log("DATO",this.$el.find(".subtemplate-wrapper" )[0])
	    colorOriginal=$(this.$el.find(".subtemplate-wrapper" )[0]).css("background-color");
	 }
	...
	console.log("MOMO",this.model.attributes.field_type)
	  fieldTypeSeleccionado=this.model.attributes.field_type;
  ...
  BuilderView = (function(_super) {
	...
	console.log("addOne",responseField)
		fieldTypeSeleccionado=responseField.attributes.field_type;
      ...
      view = new ViewFieldView({
	    ...
	    view2 = new ViewFieldView({
        model: responseField,
        parentView: this
      });
	    view3 = new ViewFieldView({
        model: responseField,
        parentView: this
      });
      if (options.$replaceEl != null) {
	  console.log("a",view.render().el)
	  console.log("options",options)
	  console.log("responseField",responseField)
	  console.log("replace",options.$replaceEl)
	  console.log("response",this.$responseFields)
	  //debugger
	  //this.$responseFields.append(view.render().el);
	  //this.$responseFields.append(view2.render().el);
       //options.$replaceEl.replaceWith(view.render().el);
//this.$responseFields.prepend(view.render().el);
this.$responseFields.append(view.render().el);
	 //this.$responseFields.prepend(view2.render().el);
	 options.$replaceEl.replaceWith("")
		//options.$replaceEl.replaceWith(view3.render().el);
      } else if ((options.position == null) || options.position === -1) {
	    console.log("responsePrimero",this.$responseFields)
	    contadorElementos++

        if (contadorElementos>idiomasSeleccionados){
	        general++;
	      contadorElementos=1;
	    }
	     console.log("idiomasTOTAL",idiomasSeleccionados)
   ...
   this.$responseFields.sortable({
        ...
        stop: function(e, ui) {
		  ...
		  //console.log("IDIOMAESS")

		  console.log("idiomasID",idiomasID)
			if (typeof idiomas != 'undefined'){
			general++
			for(var i in idiomas)
{
        console.log("EMMMMM")
					rf = _this.collection.create(Formbuilder.helpers.defaultFieldAttrs(ui.item.data('field-type'),idiomas[i],idiomasID[i]), {
              $replaceEl: ui.item
            });
}
}else{
console.log("PORACA")
	rf = _this.collection.create(Formbuilder.helpers.defaultFieldAttrs(ui.item.data('field-type'),"Aleman",1), {
              $replaceEl: ui.item
            });
}

			//rf = _this.collection.create(Formbuilder.helpers.defaultFieldAttrs(ui.item.data('field-type'),"Ingles"), {
             // $replaceEl: ui.item
           // });
  ...
  Formbuilder = (function() {
    Formbuilder.helpers = {
      defaultFieldAttrs: function(field_type,language,languageID) {
        var attrs, _base;
        attrs = {};
        attrs[Formbuilder.options.mappings.LABEL] = 'Sin Titulo';
		attrs[Formbuilder.options.mappings.LANGUAGE] = '('+language+')';
		attrs[Formbuilder.options.mappings.LANGUAGEID] = languageID;
    ...
    Formbuilder.options = {
      ...
      dict: {
        ...
        SAVE_FORM: 'Guardar Encuesta',
        UNSAVED_CHANGES: 'Tenes cambios sin guardar,si deja esta pagina,perdera los cambios!'
      }
    };
...
/*(function() {
  Formbuilder.registerField('address', {
    ...
    edit: "",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-home\"></span></span> Direccion"
  });
...
/*(function() {
  Formbuilder.registerField('date', {
    ...
    edit: "",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-calendar\"></span></span> Fechas"
  });
...
(function() {
  Formbuilder.registerField('dropdown', {
    ...
    addButton: "<span class=\"symbol\"><span class=\"fa fa-caret-down\"></span></span> Combo",
    defaultAttributes: function(attrs) {
      attrs.field_options.options = [
        {
          label: "",
...
(function() {
  Formbuilder.registerField('number', {
    ...
    addButton: "<span class=\"symbol\"><span class=\"fa fa-number\">123</span></span> Numero"
  });
...
/*(function() {
  Formbuilder.registerField('price', {
    ...
    edit: "",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-usd\"></span></span> Precio"
  });
...
(function() {
  Formbuilder.registerField('section_break', {
    ...
    edit: "<div class='fb-edit-section-header'>Etiqueta</div>\n<input type='text' data-rv-input='model.<%= Formbuilder.options.mappings.LABEL %>' />\n<textarea data-rv-input='model.<%= Formbuilder.options.mappings.DESCRIPTION %>'\n  placeholder='Agregar una descripcion a este campo'></textarea>",
    addButton: "<span class='symbol'><span class='fa fa-minus'></span></span> Salto de Linea"
  });
...
(function() {
  Formbuilder.registerField('text', {
    ...
    view: "<input type='text' class='rf-size-<%= rf.get(Formbuilder.options.mappings.SIZE) %>' />",
    edit: "<%= Formbuilder.templates['edit/size']() %>\n<%= Formbuilder.templates['edit/min_max_length']() %>",
    addButton: "<span class='symbol'><span class='fa fa-font'></span></span> Texto",
    defaultAttributes: function(attrs) {
      attrs.field_options.size = 'small';
      return attrs;
    }
...
(function() {
  Formbuilder.registerField('time', {
    ...
    view: "<div class='input-line'>\n  <span class='hours'>\n    <input type=\"text\" />\n    <label>HH</label>\n  </span>\n\n  <span class='above-line'>:</span>\n\n  <span class='minutes'>\n    <input type=\"text\" />\n    <label>MM</label>\n  </span>\n\n  <span class='above-line'>:</span>\n\n  <span class='seconds'>\n    <input type=\"text\" />\n    <label>SS</label>\n  </span>\n\n  <span class='am_pm'>\n    <select>\n      <option>AM</option>\n      <option>PM</option>\n    </select>\n  </span>\n</div>",
    edit: "",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-clock-o\"></span></span> Horario"
  });
...
'"></span>\n  <code class=\'field-type\' </code>\n <span>'+getTextoControl()+'</span> <span class=\'fa fa-arrow-right pull-right\'></span>\n</div>';

}
console.log("TIPO",Formbuilder.options.mappings.FIELD_TYPE,__t,this)
return __p
};
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-edit-section-header\'>Etiqueta</div>\n\n<div class=\'fb-common-wrapper\'>\n  <div class=\'fb-label-description\'>\n    ' +
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-edit-section-header\'>Solo Enteros</div>\n<label>\n  <input type=\'checkbox\' data-rv-checked=\'model.' +
((__t = ( Formbuilder.options.mappings.INTEGER_ONLY )) == null ? '' : __t) +
'\' />\n  Solo aceptar enteros\n</label>\n';
...
'\'\n  placeholder=\'Agregar una descripcion\'></textarea>';
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-edit-section-header\'>Minimo / Maximo</div>\n\nArriba\n<input type="text" data-rv-input="model.' +
((__t = ( Formbuilder.options.mappings.MIN )) == null ? '' : __t) +
'" style="width: 30px;padding: initial;" />\n\n&nbsp;&nbsp;\n\nAbajo\n<input type="text" data-rv-input="model.' +
...
with (obj) {
__p += '<div class=\'fb-edit-section-header\'>Opciones</div>\n\n';
...
'" title="Agregar Opcion"><i class=\'fa fa-plus-circle\'></i></a>\n  <a class="js-remove-option ' +
((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
'" title="Remover Opcion"><i class=\'fa fa-minus-circle\'></i></a>\n</div>\n\n';
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-edit-section-header\'>Unidades</div>\n<input type="text" data-rv-input="model.' +
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-left\'>\n  <ul class=\'fb-tabs\'>\n    <li class=\'active\'><a data-target=\'#addField\'>Agregar nuevo campo</a></li>\n    <li><a data-target=\'#editField\'>Editar Campos</a></li>\n  </ul>\n\n  <div class=\'fb-tab-content\'>\n    ' +
...
with (obj) {
if (general% 2){
colorFondo="rgb(91, 124, 90)"
}else{
colorFondo="rgb(125, 157, 235)"

}
if (colorOriginal!=""){
colorFondo=colorOriginal;
}
__p += '<div class=\'subtemplate-wrapper\'style="background-color: '+colorFondo+';color:black;">\n  <div class=\'cover\'></div>\n  ' +
...
((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
'" title="Duplicar Campo"><i class=\'fa fa-plus-circle\'></i></a>\n  <a class="js-clear ' +
((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
'" title="Remover Campo"><i class=\'fa fa-minus-circle\'></i></a>\n</div>';
...
function print() { __p += __j.call(arguments, '') }
with (obj) {
//console.log("sd",Formbuilder.options.mappings)

value=rf.get(Formbuilder.options.mappings.LANGUAGE)

//console.log("LAN",Formbuilder.options.mappings)
//console.log("rf",rf)
__p += '<label>\n  <span>' +
...
__p += '\n</label>\n';
__p += '<p style="font-weight: bold">'+value+' :</p>';
