                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4">
                                <fieldset class="input-block">
                                    ...
                                    <input name="fechaFinal" type="text" id="fechaFinal" class="datepicker " placeholder="Finaliza en.." required />
...
">
    ...
    font-size: 24px;">Guardar como plantilla</label>
                    ...
                    <div class="prev">
                        <button class="button button-control" type="button" id="anterior"><span>Anterior Paso <b></b></span>
                        </button>
    ...
    <script>
        ...
        function rellenarCampos() {
            ...
            for (var i in encuesta.textoFinal) {
                $("#textoFinal").append('<label>Texto Final (' + encuesta.textoInicial[i]["idiomaNombre"] + ')</label><input name="textoFinal" type="text" placeholder="Texto" required value=' + encuesta.textoInicial[i]["valor"] + ' idioma=' + encuesta.textoInicial[i]["idioma"] + ' class="noBorrarFinal"/ />')
